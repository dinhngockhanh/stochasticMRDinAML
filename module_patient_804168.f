...
*	TCGA ID of the patient
      character(len=6),parameter	:: str_ID 	= '804168'
...
*	Equilibrium hematopoietic mitotic cell numbers
      double precision,parameter	:: weight 	= 79.3D0
...
*	Number of cells in blood at primary/diagnosis
      double precision,parameter	:: diag_normal = 1.54D0*(10.0D0**11)
      double precision,parameter	:: diag_blast  = 2.29D0*(10.0D0**11)
...
C     .		          reshape((/3.3D0,4.5D0,
C     .					  3.3D0,4.5D0/),shape(CHEMO_TIME))
*	Time until relapse
      double precision,parameter	:: T_RELAPSE	= 235.0D0
