...
*	TCGA ID of the patient
      character(len=6),parameter	:: str_ID 	= '452198'
*	Number of cancer clones
      integer,parameter			:: N_clones	= 4
*	Number of species
      integer,parameter			:: N_total	= 2 + N_clones*2
*	Equilibrium hematopoietic mitotic cell numbers
      double precision,parameter	:: weight 	= 103.6D0
...
C     .		         reshape((/1.6D0,4.5D0,
C     .					 1.6D0,4.5D0/),shape(CHEMO_TIME))
C     	double precision,parameter	:: CHEMO_STRE(1:CHEMO_TOTAL,1:2) =
C     .		         reshape((/1.8D0,1.8D0,
C     .					 5.5D0,5.5D0/),shape(CHEMO_TIME))
*	Time until relapse
      double precision,parameter	:: T_RELAPSE	= 505.0D0
